...
const MatAllInclusive: IconDefinition = {
  name: 'mat-all-inclusive',
  theme: 'outline',
  icon: {
    tag: 'svg',
    attrs: {
...
export default MatAllInclusive;
