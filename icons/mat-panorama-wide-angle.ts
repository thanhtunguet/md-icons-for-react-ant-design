...
const MatPanoramaWideAngle: IconDefinition = {
  name: 'mat-panorama-wide-angle',
  theme: 'outline',
  icon: {
    tag: 'svg',
    attrs: {
...
export default MatPanoramaWideAngle;
