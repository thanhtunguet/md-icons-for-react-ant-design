...
const MatRotate90DegreesCcw: IconDefinition = {
  name: 'mat-rotate-90-degrees-ccw',
  theme: 'outline',
  icon: {
    tag: 'svg',
    attrs: {
...
export default MatRotate90DegreesCcw;
