...
const MatSyncDisabled: IconDefinition = {
  name: 'mat-sync-disabled',
  theme: 'outline',
  icon: {
    tag: 'svg',
    attrs: {
...
export default MatSyncDisabled;
