...
const MatSpeakerGroup: IconDefinition = {
  name: 'mat-speaker-group',
  theme: 'outline',
  icon: {
    tag: 'svg',
    attrs: {
...
export default MatSpeakerGroup;
