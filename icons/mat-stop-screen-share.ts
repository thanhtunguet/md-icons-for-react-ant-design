...
const MatStopScreenShare: IconDefinition = {
  name: 'mat-stop-screen-share',
  theme: 'outline',
  icon: {
    tag: 'svg',
    attrs: {
...
export default MatStopScreenShare;
