...
const MatStrikethroughS: IconDefinition = {
  name: 'mat-strikethrough-s',
  theme: 'outline',
  icon: {
    tag: 'svg',
    attrs: {
...
export default MatStrikethroughS;
