...
const MatPortableWifiOff: IconDefinition = {
  name: 'mat-portable-wifi-off',
  theme: 'outline',
  icon: {
    tag: 'svg',
    attrs: {
...
export default MatPortableWifiOff;
